                ...
                <div class="vtabs customvtab m-t-10">
                    ...
                    <div class="tab-content">
                        <div id="vhome3" class="tab-pane active">
                            {!! Form::open(['method'=>'POST','route' => ['admin.shifts.store'],'id'=>'create-shift-form']) !!}
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-xs-12">
                                        ...
                                        <div class="col">
                                            <div class="form-group {{$errors->has('shift_date') ? 'has-error' : '' }}">
                                                ...
                                                <div class="input-group date" id="date1" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" name="shift_date" data-target="#date1" value="{{old('shift_date')}}"/>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <input type="radio" checked  class=""  id="recurring_type"
                                                       name="shift_type" value="1" {{old('shift_type') ? old('shift_type')=='1' ? 'checked' : '' : '' }}>
                                                <label for="">@lang('shifts::app.recurring')</label>
                                                <br>

                                                <input type="radio" class="" id="cyclic_type"
                                                       name="shift_type" value="2" {{old('shift_type') ? old('shift_type')=='2' ? 'checked' : '' : '' }}>
                                                <label for="">@lang('shifts::app.cyclic')</label>

                                                <br>
                                                <input type="radio" class="" id="free_type"
                                                       name="shift_type"
                                                       value="3" {{old('shift_type') ? old('shift_type')=='3' ? 'checked' : '' : '' }}>
                                                <label for="">@lang('shifts::app.free')</label>

                                            </div>
                                        </div>

                                        <div class="col-sm-12 col-md-5 col-xs-12  cyclic_duration hide">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date {{$errors->has('start_min_time') ? 'errorBorder' : ''}}" id="datetimepicker1" data-target-input="nearest">
                                                    <input   type="text" name="start_min_time" value="{{old('start_min_time')}}" class="form-control  datetimepicker-input" data-target="#datetimepicker1" id="startTime"/>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date {{$errors->has('start_time') ? 'errorBorder' : ''}}"  id="datetimepicker2" data-target-input="nearest">
                                                    <input type="text"  name="start_time" value="{{old('start_time')}}"   class="form-control datetimepicker-input" data-target="#datetimepicker2" id="endTime"/>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date {{$errors->has('start_max_time') ? 'errorBorder' : ''}}"  id="datetimepicker3" data-target-input="nearest">
                                                    <input type="text"  name="start_max_time" value="{{old('start_max_time')}}"  class="form-control datetimepicker-input" data-target="#datetimepicker3" id="endTime"/>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date {{$errors->has('finish_min_time') ? 'errorBorder' : ''}}"  id="datetimepicker4" data-target-input="nearest">
                                                    <input type="text" value="{{old('finish_min_time')}}" name="finish_min_time"  class="form-control datetimepicker-input" data-target="#datetimepicker4" id="endTime"/>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date {{$errors->has('finish_time') ? 'errorBorder' : ''}}"  id="datetimepicker5" data-target-input="nearest">
                                                    <input type="text"  name="finish_time" value="{{old('finish_time')}}"  class="form-control datetimepicker-input" data-target="#datetimepicker5" id="endTime"/>
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date {{$errors->has('finish_max_time') ? 'errorBorder' : ''}}"  id="datetimepicker6" data-target-input="nearest">
                                                    <input type="text" value="{{old('finish_max_time')}}"  name="finish_max_time"  class="form-control datetimepicker-input" data-target="#datetimepicker6" id="endTime"/>
                                    ...
                                    <div class="row hide" id="work_time">
                                    ...
                                    <div class="row hide" id="work_range_time">
                                        ...
                                        <div class="col-sm-12 col-md-2 col-xs-12" >
                                            <div class="form-group" id="work_range">
                                                <input type="radio" checked class=""  id="work_range_yes"
                                                       name="work_range_type"
                                                       value="1">
                                                <label for="">@lang('app.yes')</label>
                                                <br>
                                                <input type="radio" class="" value="0" id="work_range_no"
                                                       name="work_range_type">
                                        ...
                                        <div class="col-sm-12 col-md-3 col-xs-12  work_time_range_period">
                                            <div class="form-group {{$errors->has('work_range_from') ? 'has-error' : ''}}">
                                                ...
                                                <div class="input-group date {{$errors->has('work_range_from') ? 'errorBorder' : ''}}"  id="datetimepicker7" data-target-input="nearest">
                                                    <input type="text" value="{{old('work_range_from')}}"  name="work_range_from"  class="form-control datetimepicker-input" data-target="#datetimepicker7" id="endTime"/>
                                        ...
                                        <div class="col-sm-12 col-md-3 col-xs-12 work_time_range_period">
                                            <div class="form-group {{$errors->has('work_range_to') ? 'has-error' : ''}}">
                                                ...
                                                <div class="input-group date {{$errors->has('work_range_to') ? 'errorBorder' : ''}}"  id="datetimepicker8" data-target-input="nearest">
                                                    <input type="text" value="{{old('work_range_to')}}"  name="work_range_to"  class="form-control datetimepicker-input" data-target="#datetimepicker8" id="endTime"/>
                                    ...
                                    <div class="row">
                                        <div class="form-group {{$errors->has('break_time') ? 'has-error' : ''}}">
                                            <div class="col-sm-12 col-md-5 col-xs-12 custom_label">
                                                ...
                                                <label for="break_time">@lang('shifts::app.breakTime') </label>

                                            </div>
                                            <div class="col-sm-12 col-md-4 col-xs-12">
                                                <input type="text" name="break_time" value="{{old('break_time')}}" class="form-control " id="break_time" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-3 col-xs-12" >
                                            <div class="form-group" id="range">
                                                <input type="radio" checked class=""  id="range_yes"
                                                       name="range_type"
                                                       value="1">
                                                <label for="">@lang('app.yes')</label>
                                                <br>
                                        ...
                                        <div class="col-sm-12 col-md-3 col-xs-12 range_period">
                                            <div class="form-group {{$errors->has('from') ? 'has-error' : ''}}">
                                                <label for="from">@lang('app.from')</label>
                                                <div class="input-group date {{$errors->has('from') ? 'errorBorder' : ''}}"  id="datetimepicker9" data-target-input="nearest">
                                                    <input type="text" value="{{old('from')}}"  name="from"  class="form-control datetimepicker-input" data-target="#datetimepicker9" id="endTime"/>
                                        ...
                                        <div class="col-sm-12 col-md-3 col-xs-12 range_period">
                                            <div class="form-group {{$errors->has('to') ? 'has-error' : ''}}">
                                                <label for="to">@lang('app.to')</label>
                                                <div class="input-group date {{$errors->has('to') ? 'errorBorder' : ''}}"  id="datetimepicker0" data-target-input="nearest">
                                                    <input type="text" value="{{old('to')}}"  name="to"  class="form-control datetimepicker-input" data-target="#datetimepicker0" id="endTime"/>
                                        ...
                                        <div class="col-sm-12 col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <div class="switchery-demo">
                                                    <input type="checkbox" id="unhealty_shit" name="unhealty_shit" class="unhealty_shit" data-size="small" data-color="#00c292" data-secondary-color="#f96262" style="display: none;" data-switchery="true">
                                ...
                                <div class="col-sm-12 col-md-6 col-xs-12">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-xs-12" id="recurring_weekday">
                                            ...
                                            <div class="weekdays {{$errors->has('weekday') ? 'errorBorder' : ''}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="weekdayButton" checked name="weekday[]" value="Mon" id="togBtn">
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="weekdayButton" name="weekday[]" value="Tue" id="togBtn">
                                                        <div class="slider round">
                                                            <!--ADDED HTML -->
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox"  class="weekdayButton" name="weekday[]" value="Wed" id="togBtn">
                                                        <div class="slider round">
                                                            <!--ADDED HTML -->
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="weekdayButton" name="weekday[]" value="Thu" id="togBtn">
                                                        <div class="slider round">
                                                            <!--ADDED HTML -->
                                                            <span class="on">T</span>
                                                            <span class="off">T</span>
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="weekdayButton" name="weekday[]" value="Fri" id="togBtn">
                                                        <div class="slider round">
                                                            <!--ADDED HTML -->
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="weekdayButton" name="weekday[]" value="Sat" id="togBtn">
                                                        <div class="slider round">
                                                            <!--ADDED HTML -->
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" class="weekdayButton" name="weekday[]" value="Sun" id="togBtn">
                                                        <div class="slider round">
                                                            <!--ADDED HTML -->
                                                            <span class="on">S</span>
                                                            <span class="off">S</span>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xs-12 hide" id="week_day_number">
                                            <label for="shift_date">@lang('shifts::app.weekdays') <b class="error">*</b></label>
                                            <div class="weekdays {{$errors->has('weekday') ? 'errorBorder' : ''}}">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xs-12" id="end_date">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date {{$errors->has('end_on') ? 'errorBorder' : ''}}" id="date2" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"  id="end_on_input" name="end_on" value="{{old('end_on')}}" data-target="#date2"/>
...
@push('footer-script')
    ...
    <script>
        ...
        var typeValue = $('input[name="shift_type"]:checked').val();
        ...
        $('#project').on('change',function () {
            ...
            $.ajax ({
                ...
                success: function(reponse) {
                    var options ='<option value="0">"@lang('shifts::app.selectProjectTask')"</option>';
